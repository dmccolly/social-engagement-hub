 ...
 *
 * Props:
 *  - event: Pre-loaded event object. If provided, no fetch will occur.
 *  - eventId: ID of the event to fetch from the backend. Ignored if event is provided.
 *  - baseURL: Base URL used for RSVP and add-to-calendar links. Defaults to the root domain.
 */

function EventBlock({ event, eventId, baseURL = '' }) {
